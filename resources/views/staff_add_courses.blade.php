...
<body>
	<div class="navbar">
		...
		<div class="second-topnav">
			<a href="staff_home.html">Home</a>
			<a href="staff_about.html">About</a>
			<a href="staff_forum.html">Forum</a>
	...
	<div class="main-body">
		...
		<div class="form-data">
			<form action="{{URL::to('/add_courses')}}" method="post" class="form-add-course">
				<table>
					<tr>
						<td>Course Name</td>
