...
<body>
	<div class="navbar">
		<div class="topnav">
			...
			<a href="#" class="fafa"><i class="fa fa-facebook-square"></i></a>
			<a href="#" class="fafa"><i class="fa fa-instagram"></i></a>
			<a href="#" class="fafa"><i class="fa fa-youtube-play"></i></a>
		</div>
	...
	<div class="main-body">
		...
		<div class="form-data">
			<form action="/add_users" method="post" class="form-add-course">
				<table>
					<tr>
						<td>Name</td>
