	...
	<div class="main-body">
		<div class="about-container">
			...
			<div class="text-container">
				<h3 class="about-content">About The CMS</h3>
				<h7 class="about-content">Our team consistes of highly motivatedand skilled specialists who know how to deal with any issue that you may come across. This creates a basis for lasting relationships with our clients built on trust and mutual understanding.
				</h7>
			</div>
		</div>
	</div>
